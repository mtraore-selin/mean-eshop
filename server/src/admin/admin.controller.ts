...
export class AdminController {
  ...
  @Post('/images/add')
  async addImage(@Session() session, @Body() imageDto: ImageDto, @Query(ValidationPipe) addImageDto: AddProductImageDto): Promise<Images | Product> {
  ...
  async uploadImage(@Session() session, @UploadedFile() file, @Query(ValidationPipe) addImageDto: AddProductImageDto): Promise<Images | Product> {
